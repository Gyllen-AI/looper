...
public static class Program
{
    ...
    public static int Main(string[] args)
    {
        ...
        foreach (var file in files)
        {
            ...
            violations.AddRange(Law.Judge(Relative(root, file), tree.GetRoot(), StartsTheProgram(file, text), AProgramWroteIt(text)));
        }
    ...
    private static bool AProgramWroteIt(string text) =>
        text.AsSpan(0, Math.Min(text.Length, 800)).IndexOf("<auto-generated") >= 0;
