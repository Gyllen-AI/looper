...
`docs/FINDINGS.md` is the audit. Sixty-nine things that were wrong with this
tool, how each was found, and what closing it cost. Sixty-four are closed and
five are open, named, at the top of that file. A tool that publishes its own
audit — including what it still gets wrong — is making a claim that is expensive
to fake.
